public class Templates {
    static int binarySearchRecursion(int[] nums, int target) {
    ...
    static void main() {
        System.out.println(binarySearchRecursion(new int[] {-1,0,3,5,9,12}, 9)); // 4
        System.out.println(binarySearchRecursion(new int[] {-1,0,3,5,9,12}, 2)); // -1
